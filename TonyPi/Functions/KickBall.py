    ...
    while True:
        ...
        if __isRunning:
            if centerX >= 0:
                ...
                start_count = True
                if step == 1:                    
                    if x_dis - servo2 > 150:#不在中心，根据方向让机器人转向一步
                        AGC.runActionGroup('turn_left_small_step')
                    elif x_dis - servo2 < -150:
                    ...
                    if y_dis == servo1:
                        ...
                        if 270 <= x_dis - servo2 < 480:#不在中心，根据方向让机器人转向一步
                            AGC.runActionGroup('left_move_fast')
                            time.sleep(0.2)
                        elif abs(x_dis - servo2) < 170:
                            AGC.runActionGroup('left_move')
                        elif -480 < x_dis - servo2 <= -270:                      
                            AGC.runActionGroup('right_move_fast')
                            time.sleep(0.2)
                        else:
                            step = 4                   
...
def run(img):
    ...
    if area_max:  # 有找到最大面积    
        ...
        if y_dis == servo1 and abs(x_dis - servo2) < 150:
            x_dis = servo2
        else:
            ...
            x_dis = servo2 - 400 if x_dis < servo2 - 400 else x_dis          
            x_dis = servo2 + 400 if x_dis > servo2 + 400 else x_dis
        ...
        y_dis = servo1 if y_dis < servo1 else y_dis
